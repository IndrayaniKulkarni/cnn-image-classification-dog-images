...
#     example_dictionary = {'n_correct_dogs': 30, 'pct_correct_dogs': 100.0, 'n_correct_breed': 24, 'pct_correct_breed': 80.0}
    ...
    results_stats_dic["pct_label_match"] = (Y/Z)*100 if Z > 0 else 0
